...
export function FaqSection() {
  ...
  return (
    <section id="faq" className="scroll-mt-24 py-8 sm:py-10" aria-labelledby="faq-heading">
      <div className={SECTION_SHELL}>
        ...
        >
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground sm:text-base">{LANDING_FAQ_INTRO.lede}</p>
        </motion.div>
        ...
        <div className="mt-8 gap-x-6 lg:columns-2">
          {LANDING_FAQ_GROUPS.map((group, gi) => (
            ...
            >
              ...
              <Accordion
                type="single"
                collapsible
                className="mt-3 rounded-lg border border-border/50 bg-background/20 px-4 shadow-[0_14px_34px_-30px_hsl(var(--foreground)/0.45)] backdrop-blur-md dark:border-white/10 dark:bg-white/5 sm:px-5"
              >
