...
const PROVIDER_COLORS: Record<string, string> = {
  ...
  sentry:         'bg-purple-100 text-purple-600',
  okta:           'bg-sky-100 text-sky-600',
  auth0:          'bg-orange-100 text-orange-700',
  keycloak:       'bg-blue-100 text-blue-600',
  razorpay:       'bg-blue-100 text-blue-700',
  magento:        'bg-orange-100 text-orange-600',
  bigcommerce:    'bg-blue-100 text-blue-600',
  mixpanel:       'bg-purple-100 text-purple-600',
  segment:        'bg-teal-100 text-teal-600',
  amplitude:      'bg-blue-100 text-blue-500',
  elasticsearch:  'bg-yellow-100 text-yellow-700',
  todoist:        'bg-red-100 text-red-600',
  box:            'bg-blue-100 text-blue-600',
  minio:          'bg-red-100 text-red-600',
  snowflake:      'bg-sky-100 text-sky-500',
  sqlite:         'bg-blue-100 text-blue-700',
  reddit:         'bg-orange-100 text-orange-600',
  google_analytics: 'bg-orange-100 text-orange-600',
  google_veo:     'bg-blue-100 text-blue-600',
  azure_openai:   'bg-sky-100 text-sky-700',
  microsoft_dynamics: 'bg-blue-100 text-blue-700',
};
...
const PROVIDER_INITIALS: Record<string, string> = {
  ...
  smtp: '@',
  intuit: 'QB',
  docker: 'Do', kubernetes: 'K8s', pagerduty: 'PD', datadog: 'Dd', sentry: 'Se',
  okta: 'Ok', auth0: 'A0', keycloak: 'Kc', razorpay: 'Rp', magento: 'Mt',
  bigcommerce: 'Bc', mixpanel: 'Mx', segment: 'Sg', amplitude: 'Am',
  elasticsearch: 'Es', todoist: 'Td', box: 'Bx', minio: 'Mi', snowflake: 'Sf',
  sqlite: 'Sq', reddit: 'Re', google_analytics: 'GA', google_veo: 'Gv',
  azure_openai: 'Az', microsoft_dynamics: 'MD',
};
