...
export class UnifiedNodeRegistry implements INodeRegistry {
  ...
  private readonly ALIAS_MAP: Record<string, string> = {
    ...
    'outlook trigger': 'outlook_trigger',
    'new outlook email': 'outlook_trigger',
    'new outlook message': 'outlook_trigger',
    'outlook calendar trigger': 'outlook_trigger',
    'new calendar invite': 'outlook_trigger',
    ...
    'slack trigger': 'slack_trigger',
    'slack event trigger': 'slack_trigger',
    'slack app mention': 'slack_trigger',
    'incoming slack message': 'slack_trigger',
    'receive slack message': 'slack_trigger',
    'slack slash command': 'slack_trigger',
    'slack interaction': 'slack_trigger',
    'when someone mentions me in slack': 'slack_trigger',
    // ── Google Sheets ────────────────────────────────────────────────────────
    ...
    'google sheets trigger': 'google_sheets_trigger',
    'new row in google sheets': 'google_sheets_trigger',
    'new spreadsheet row': 'google_sheets_trigger',
    'row added to sheet': 'google_sheets_trigger',
    // ── Google services ──────────────────────────────────────────────────────
    'gdoc': 'google_doc',
    ...
    'drive': 'google_drive',
    'google_drive_trigger': 'google_drive_trigger',
    'google drive trigger': 'google_drive_trigger',
    'new file in drive': 'google_drive_trigger',
    'file added to drive': 'google_drive_trigger',
    'drive file changed': 'google_drive_trigger',
    'gcal': 'google_calendar',
    'calendar': 'google_calendar',
    'google_cal': 'google_calendar',
    'google_calendar': 'google_calendar',
    'google_calendar_trigger': 'google_calendar_trigger',
    'google calendar trigger': 'google_calendar_trigger',
    'new calendar event': 'google_calendar_trigger',
    'calendar event trigger': 'google_calendar_trigger',
    'google calendar watch': 'google_calendar_trigger',
    // ── Triggers ─────────────────────────────────────────────────────────────
    'typeform_trigger': 'typeform_trigger',
    'typeform trigger': 'typeform_trigger',
    'new typeform response': 'typeform_trigger',
    'new form response': 'typeform_trigger',
    'typeform submission': 'typeform_trigger',
    'tally_trigger': 'tally_trigger',
    'tally trigger': 'tally_trigger',
    'new tally response': 'tally_trigger',
    'new tally submission': 'tally_trigger',
    'tally submission': 'tally_trigger',
    'tally form submission': 'tally_trigger',
    ...
    'chat_send': 'chat_send',
    'chat send': 'chat_send',
    'chat response': 'chat_send',
    'reply to chat': 'chat_send',
    'send to chat': 'chat_send',
    'telegram_trigger': 'telegram_trigger',
    'telegram webhook': 'telegram_trigger',
    'telegram bot trigger': 'telegram_trigger',
    'incoming telegram message': 'telegram_trigger',
    'when someone messages my bot': 'telegram_trigger',
    'whatsapp webhook': 'whatsapp_trigger',
    'whatsapp cloud trigger': 'whatsapp_trigger',
    'incoming whatsapp message': 'whatsapp_trigger',
    'receive whatsapp message': 'whatsapp_trigger',
    'when someone messages my whatsapp': 'whatsapp_trigger',
    'instagram webhook': 'instagram_trigger',
    'instagram dm trigger': 'instagram_trigger',
    'incoming instagram message': 'instagram_trigger',
    'receive instagram message': 'instagram_trigger',
    'instagram comment trigger': 'instagram_trigger',
    'instagram mention trigger': 'instagram_trigger',
    'instagram story reply': 'instagram_trigger',
    'when someone messages my instagram': 'instagram_trigger',
    ...
    'discord trigger': 'discord_trigger',
    'discord event trigger': 'discord_trigger',
    'discord slash command': 'discord_trigger',
    'discord interaction': 'discord_trigger',
    'incoming discord message': 'discord_trigger',
    'when someone uses discord command': 'discord_trigger',
    ...
    'microsoft_teams_trigger': 'microsoft_teams_trigger',
    'teams_trigger': 'microsoft_teams_trigger',
    'teams trigger': 'microsoft_teams_trigger',
    'microsoft teams trigger': 'microsoft_teams_trigger',
    'incoming teams message': 'microsoft_teams_trigger',
    'teams bot trigger': 'microsoft_teams_trigger',
    'gmail_trigger': 'gmail_trigger',
    'gmail trigger': 'gmail_trigger',
    'google_gmail_trigger': 'gmail_trigger',
    'new gmail message': 'gmail_trigger',
    'new email received': 'gmail_trigger',
    'incoming gmail message': 'gmail_trigger',
    'gmail watch': 'gmail_trigger',
    ...
    'facebook_page_trigger': 'facebook_trigger',
    'facebook_page_message': 'facebook_trigger',
    'incoming_facebook_message': 'facebook_trigger',
    'receive_facebook_message': 'facebook_trigger',
    'facebook_comment_trigger': 'facebook_trigger',
    'facebook_mention_trigger': 'facebook_trigger',
    'facebook_leadgen_trigger': 'facebook_trigger',
    'youtube': 'youtube',
    'yt': 'youtube',
    'linkedin': 'linkedin',
    'linked_in': 'linkedin',
    ...
    'github trigger': 'github_trigger',
    'new github push': 'github_trigger',
    'new github issue': 'github_trigger',
    'new github pull request': 'github_trigger',
    'github webhook': 'github_trigger',
    'gitlab': 'gitlab',
    'git_lab': 'gitlab',
    'gitlab_trigger': 'gitlab_trigger',
    'gitlab trigger': 'gitlab_trigger',
    'new gitlab push': 'gitlab_trigger',
    'new gitlab issue': 'gitlab_trigger',
    'new gitlab merge request': 'gitlab_trigger',
    'gitlab webhook': 'gitlab_trigger',
    'bitbucket': 'bitbucket',
    'jira': 'jira',
    'jira_trigger': 'jira_trigger',
    'jira trigger': 'jira_trigger',
    'new jira issue': 'jira_trigger',
    'jira issue created': 'jira_trigger',
    'jira issue updated': 'jira_trigger',
    'jira comment': 'jira_trigger',
    'jira webhook': 'jira_trigger',
    'linear_trigger': 'linear_trigger',
    'linear trigger': 'linear_trigger',
    'new linear issue': 'linear_trigger',
    'linear issue created': 'linear_trigger',
    'linear issue updated': 'linear_trigger',
    'linear comment': 'linear_trigger',
    'linear webhook': 'linear_trigger',
    'trello_trigger': 'trello_trigger',
    'trello trigger': 'trello_trigger',
    'new trello card': 'trello_trigger',
    'trello card moved': 'trello_trigger',
    'trello card comment': 'trello_trigger',
    'trello webhook': 'trello_trigger',
    // ── Storage ──────────────────────────────────────────────────────────────
    'aws_s3': 'aws_s3',
    's3': 'aws_s3',
    'amazon_s3': 'aws_s3',
    ...
    'shopify trigger': 'shopify_trigger',
    'new shopify order': 'shopify_trigger',
    'shopify order paid': 'shopify_trigger',
    'shopify order created': 'shopify_trigger',
    'shopify customer created': 'shopify_trigger',
    'shopify product updated': 'shopify_trigger',
    'shopify webhook': 'shopify_trigger',
    'stripe': 'stripe',
    'stripe_trigger': 'stripe_trigger',
    'stripe trigger': 'stripe_trigger',
    'new stripe payment': 'stripe_trigger',
    'stripe payment succeeded': 'stripe_trigger',
    'stripe checkout completed': 'stripe_trigger',
    'stripe invoice paid': 'stripe_trigger',
    'stripe subscription updated': 'stripe_trigger',
    'stripe webhook': 'stripe_trigger',
    // ── Cache ─────────────────────────────────────────────────────────────────
    'cache_get': 'cache_get',
    'cache_set': 'cache_set',
  ...
  > = {
    ...
    slack_trigger: { credentialTypeId: 'slack_oauth2',         label: 'Slack OAuth2',             authType: 'oauth2' },
    ...
    google_calendar_trigger: { credentialTypeId: 'google_oauth2', label: 'Google OAuth2', authType: 'oauth2' },
    google_sheets_trigger: { credentialTypeId: 'google_oauth2', label: 'Google OAuth2', authType: 'oauth2' },
    google_drive_trigger: { credentialTypeId: 'google_oauth2', label: 'Google OAuth2', authType: 'oauth2' },
    ...
    github_trigger: { credentialTypeId: 'github_pat',          label: 'GitHub Personal Token',    authType: 'bearer_token' },
    gitlab:        { credentialTypeId: 'gitlab_pat',           label: 'GitLab Personal Token',    authType: 'bearer_token' },
    gitlab_trigger: { credentialTypeId: 'gitlab_pat',          label: 'GitLab Personal Token',    authType: 'bearer_token' },
    ...
    jira_trigger:  { credentialTypeId: 'jira_api_key',         label: 'Jira API Key',             authType: 'basic_auth' },
    ...
    tally_trigger: { credentialTypeId: 'tally_token',          label: 'Tally Token',               authType: 'bearer_token' },
