    ...
    questions: [
      {
        ...
        field: 'expression',
        prompt: 'Expression to evaluate (e.g. {{$json.status}}) — must match a case value',
        type: 'string',
        required: true,
        askOrder: 1,
        example: '{{$json.status}}',
      ...
      },
      {
        id: 'switch_cases',
        field: 'cases',
        prompt: 'Cases (JSON array): each { value, label? } — value becomes the output port name',
        type: 'json',
        required: true,
        askOrder: 2,
        example: [
      ...
      },
      {
        ...
        field: 'routingType',
        prompt: 'Optional: how the expression is interpreted',
        type: 'select',
        required: false,
        askOrder: 3,
        options: [
    ...
    questions: [
      {
        id: 'function_code',
        field: 'code',
        prompt: 'Provide JavaScript code to run against the incoming data',
        type: 'code',
        required: true,
        askOrder: 1,
    ...
    questions: [
      {
        ...
        field: 'code',
        prompt: 'Provide JavaScript code for each item in input.items',
        type: 'code',
        required: true,
        askOrder: 1,
  ...
  google_gmail: {
    ...
    questions: [
      ...
      },
      {
        ...
        example: 'recipient@example.com, second@example.com',
      },
      {
        id: 'gmail_subject',
        field: 'subject',
