...
exports.isFieldUserProvidedText = isFieldUserProvidedText;
exports.shouldUseSelectForExplicitOptions = shouldUseSelectForExplicitOptions;
/** Free-form user values — never force a select from schema `options`. */
function isFieldUserProvidedText(fieldName) {
 ...
 */
function shouldUseSelectForExplicitOptions(fieldName, fieldInfo) {
