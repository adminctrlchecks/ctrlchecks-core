...
exports.isEffectivelyEmptyUpstreamPayload = isEffectivelyEmptyUpstreamPayload;
exports.isUpstreamNarrativelyThinForRuntimeAi = isUpstreamNarrativelyThinForRuntimeAi;
function isMeaningfulLeafValue(value) {
 ...
 */
function isEffectivelyEmptyUpstreamPayload(output) {
 ...
 */
function isUpstreamNarrativelyThinForRuntimeAi(output) {
