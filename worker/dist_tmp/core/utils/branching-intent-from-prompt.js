...
exports.detectBranchingIntentFromPrompt = detectBranchingIntentFromPrompt;
/**
 * Returns true when the prompt likely requires if_else (or switch) rather than a purely linear flow.
 */
function detectBranchingIntentFromPrompt(fullText) {
    ...
    return ((hasConditionalKeywords || hasConditionalPatterns) &&
        !isTriggerWhen &&
        !isDataExtraction &&
        !isLinearThen);
}
