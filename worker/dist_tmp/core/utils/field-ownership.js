...
exports.classifyFieldOwnership = classifyFieldOwnership;
exports.isStructuralOwnership = isStructuralOwnership;
exports.isCredentialOwnership = isCredentialOwnership;
const STRICT_CREDENTIAL_CATEGORIES = new Set([
    'api_key',
    'oauth_token',
    'refresh_token',
    'client_id',
...
function classifyFieldOwnership(fieldName, field) {
...
function isStructuralOwnership(fieldName, field) {
    return (field.ownership ?? classifyFieldOwnership(fieldName, field)) === 'structural';
}
function isCredentialOwnership(fieldName, field) {
