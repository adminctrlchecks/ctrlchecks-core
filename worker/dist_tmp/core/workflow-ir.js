...
exports.WorkflowIRConverter = exports.WorkflowIRRepairer = exports.WorkflowIRValidator = exports.WorkflowIRBuilder = void 0;
/**
 * Workflow IR Builder
 * Converts planner output to IR
 */
class WorkflowIRBuilder {
    /**
     * Convert workflow plan to IR
     */
    static fromPlan(plan, userPrompt) {
     ...
     */
    static generateDataBindings(trigger, steps) {
        const bindings = [];
        if (steps.length === 0) {
            return bindings;
        }
     ...
     */
    static extractConditions(steps) {
        const conditions = [];
...
exports.WorkflowIRBuilder = WorkflowIRBuilder;
/**
...
exports.WorkflowIRValidator = WorkflowIRValidator;
/**
 * Workflow IR Repairer
 * Automatically repairs common IR issues
 */
class WorkflowIRRepairer {
    /**
     * Repair IR structure
     */
    static repair(ir) {
        ...
        if (repaired.dataBindings.length === 0 && repaired.steps.length > 0) {
            repaired.dataBindings = WorkflowIRBuilder['generateDataBindings'](repaired.trigger, repaired.steps);
...
class WorkflowIRConverter {
    ...
    static toStructure(ir) {
        ...
        const outputs = ir.steps.length > 0
            ? [{
                    name: 'output_1',
...
exports.WorkflowIRConverter = WorkflowIRConverter;
