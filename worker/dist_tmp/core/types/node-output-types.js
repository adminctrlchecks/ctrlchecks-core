...
exports.NODE_OUTPUT_SCHEMAS = void 0;
exports.getNodeOutputSchema = getNodeOutputSchema;
...
exports.NODE_OUTPUT_SCHEMAS = {
    ...Object.fromEntries(GENERIC_OBJECT_OUTPUT_NODE_TYPES.map((nodeType) => [nodeType, GENERIC_OBJECT_OUTPUT_SCHEMA])),
    // ============================================
    // TRIGGER NODES
    // ============================================
    manual_trigger: {
 ...
 */
function getNodeOutputSchema(nodeType) {
    return exports.NODE_OUTPUT_SCHEMAS[nodeType] || null;
}
/**
 ...
 */
function areTypesCompatible(sourceType, targetType, sourceNodeType, targetNodeType) {
