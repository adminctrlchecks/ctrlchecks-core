...
exports.EXPLICIT_NODE_TYPE_PATTERNS = void 0;
exports.getAllNodePatterns = getAllNodePatterns;
exports.generatePatternFromNodeType = generatePatternFromNodeType;
exports.matchNodeTypeByPattern = matchNodeTypeByPattern;
exports.getCanonicalTypeFromPattern = getCanonicalTypeFromPattern;
exports.validatePatternMatching = validatePatternMatching;
/**
 ...
 * - label
 */
exports.EXPLICIT_NODE_TYPE_PATTERNS = [
    // ============================================
...
function getAllNodePatterns() {
    if (_allNodePatterns === null) {
        try {
            ...
            const explicit = [...exports.EXPLICIT_NODE_TYPE_PATTERNS];
            ...
            _allNodePatterns = [...exports.EXPLICIT_NODE_TYPE_PATTERNS];
        }
    }
 ...
 */
function generatePatternFromNodeType(nodeType) {
    if (!nodeType) {
 ...
 */
function matchNodeTypeByPattern(nodeType, registeredTypes) {
 ...
 */
function getCanonicalTypeFromPattern(nodeType) {
