...
exports.overrideLogOutput = overrideLogOutput;
const lru_node_outputs_cache_1 = require("../../cache/lru-node-outputs-cache");
const universal_template_resolver_1 = require("../../utils/universal-template-resolver");
const placeholder_filter_1 = require("../../utils/placeholder-filter");
const log_output_executor_1 = require("../../execution/nodes/log-output-executor");
 ...
 */
function overrideLogOutput(def, _schema) {
    ...
    return {
        ...
        execute: async (context) => {
            try {
                const nodeOutputs = new lru_node_outputs_cache_1.LRUNodeOutputsCache(100, false);
                ...
                const resolvedConfig = (0, universal_template_resolver_1.resolveConfigTemplates)(context.config || {}, nodeOutputs, context.nodeType);
                const filteredConfig = (0, placeholder_filter_1.filterPlaceholderValues)(resolvedConfig);
                const filteredBaseConfig = (0, placeholder_filter_1.filterPlaceholderValues)(context.config || {});
                const mergedConfig = {
                    ...filteredBaseConfig,
                    ...filteredConfig,
                    ...(0, runtime_input_handoff_1.getAuthoritativeInputs)(context),
                };
                const rawOut = (0, log_output_executor_1.executeLogOutputWithCache)(mergedConfig, context.rawInput ?? {}, nodeOutputs);
                const cleaned = (0, placeholder_filter_1.cleanOutputFromConfig)(rawOut, filteredConfig);
