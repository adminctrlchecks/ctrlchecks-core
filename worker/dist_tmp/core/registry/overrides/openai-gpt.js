...
exports.overrideOpenAiGpt = overrideOpenAiGpt;
const ai_shared_1 = require("./ai-shared");
function overrideOpenAiGpt(def, schema) {
    ...
    const next = (0, ai_shared_1.overrideAiNodeWithIntentAwareSelection)({
        ...def,
        inputSchema,
        ...
        validateConfig: (config) => {
            ...
            if (!String(config.model || '').trim())
                errors.push("Required field 'model' is missing or empty");
