...
exports.overrideHubspot = overrideHubspot;
...
function overrideHubspot(def, schema) {
    const inputSchema = { ...def.inputSchema };
    delete inputSchema.apiKey;
    delete inputSchema.accessToken;
    delete inputSchema.credentialId;
    delete inputSchema.objectId;
    return {
        ...def,
        inputSchema: {
            ...inputSchema,
