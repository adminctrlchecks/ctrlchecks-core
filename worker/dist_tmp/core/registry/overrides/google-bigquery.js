...
exports.overrideGoogleBigQuery = overrideGoogleBigQuery;
const google_workspace_utils_1 = require("./google-workspace-utils");
function overrideGoogleBigQuery(def, _schema) {
    ...
    return {
        ...
        execute: async (context) => {
            ...
            try {
                ...
                const accessToken = await (0, google_workspace_utils_1.getGoogleTokenForContext)(context, ['https://www.googleapis.com/auth/bigquery']);
                const output = await (0, google_workspace_utils_1.googleApiRequest)(`https://bigquery.googleapis.com/bigquery/v2/projects/${encodeURIComponent(projectId)}/queries`, accessToken, {
                    method: 'POST',
