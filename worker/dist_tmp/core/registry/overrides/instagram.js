...
exports.overrideInstagram = overrideInstagram;
const social_dispatcher_1 = require("../../../services/social/social-dispatcher");
function overrideInstagram(def, _schema) {
    ...
    const field = (base, fillMode, role, ownership = 'value') => ({
        ...base,
        ownership,
        fillMode,
        ...(role ? { role } : {}),
    ...
    return {
        ...
        execute: async (context) => {
            try {
                ...
                const result = await (0, social_dispatcher_1.executeSocialNode)(db, { provider: 'instagram', operation: config.operation ?? 'sendText', ...config }, userId, currentUserId);
                return {
