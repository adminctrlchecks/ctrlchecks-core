...
exports.overrideWhatsapp = overrideWhatsapp;
const social_dispatcher_1 = require("../../../services/social/social-dispatcher");
function overrideWhatsapp(def, _schema) {
    ...
    return {
        ...
        execute: async (context) => {
            try {
                ...
                const result = await (0, social_dispatcher_1.executeSocialNode)(db, { provider: 'whatsapp', operation: config.operation ?? 'sendText', ...config }, userId, currentUserId);
                return {
