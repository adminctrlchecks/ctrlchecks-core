...
exports.getOperationSemantic = getOperationSemantic;
exports.getDSLCategoryFromSemantic = getDSLCategoryFromSemantic;
exports.isWriteOperationForNode = isWriteOperationForNode;
exports.isReadOperationForNode = isReadOperationForNode;
exports.isTransformOperationForNode = isTransformOperationForNode;
 ...
 */
function deriveSemanticFromOperationName(operation) {
 ...
 */
function getOperationSemantic(nodeType, operation) {
    ...
    let derivedFrom = 'operation_name';
 ...
 */
function getDSLCategoryFromSemantic(semantic, nodeType) {
    switch (semantic) {
        case 'read':
            return 'dataSource';
        case 'write':
 ...
 */
function isWriteOperationForNode(nodeType, operation) {
 ...
 * Uses node schema, not global list
 */
function isReadOperationForNode(nodeType, operation) {
    const semanticInfo = getOperationSemantic(nodeType, operation);
 ...
 * Uses node schema, not global list
 */
function isTransformOperationForNode(nodeType, operation) {
    const semanticInfo = getOperationSemantic(nodeType, operation);
