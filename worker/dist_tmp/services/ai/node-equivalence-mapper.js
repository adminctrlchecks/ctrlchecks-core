...
exports.nodeEquivalenceMapper = exports.NodeEquivalenceMapper = void 0;
/**
...
class NodeEquivalenceMapper {
     ...
     */
    detectMultiNodeOptions(userPrompt) {
        ...
        for (const group of this.equivalenceGroups) {
            ...
            const hasMatch = categoryKeywords.some(keyword => lowerPrompt.includes(keyword));
...
exports.NodeEquivalenceMapper = NodeEquivalenceMapper;
// Export singleton instance
exports.nodeEquivalenceMapper = new NodeEquivalenceMapper();
