...
exports.nodeCompatibilityMatrix = exports.NodeCompatibilityMatrix = void 0;
/**
...
class NodeCompatibilityMatrix {
     ...
     */
    checkCompatibility(sourceNode, targetNode) {
     ...
     */
    getAlternatives(sourceType, targetType) {
        const rule = this.compatibilityRules.find(r => {
            const sourceMatch = Array.isArray(r.sourceNode)
                ? r.sourceNode.includes(sourceType)
                : r.sourceNode === sourceType;
     ...
     */
    validateWorkflowCompatibility(nodes, edges) {
        const errors = [];
        const warnings = [];
        edges.forEach(edge => {
...
exports.NodeCompatibilityMatrix = NodeCompatibilityMatrix;
// Export singleton instance
exports.nodeCompatibilityMatrix = new NodeCompatibilityMatrix();
