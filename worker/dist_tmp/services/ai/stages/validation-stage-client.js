...
exports.runValidationStageRemote = runValidationStageRemote;
 ...
 */
async function runValidationStageRemote(workflow, catalog, userIntent, selectedNodes, proposedEdges, correlationId, structuralPrompt) {
    if (!AI_GENERATOR_URL)
        return null;
    try {
