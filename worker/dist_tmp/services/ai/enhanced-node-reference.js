...
exports.enhancedNodeReference = exports.EnhancedNodeReference = void 0;
...
class EnhancedNodeReference {
     ...
     */
    generateComprehensiveReference() {
     ...
     */
    getCredentialDescription(credType) {
        const descriptions = {
     ...
     */
    generateCredentialClassification(nodesByCategory) {
        ...
        withCreds.forEach(node => {
            const creds = node.credentials.map(c => c.handledViaNavbar ? `${c.type} (navbar)` : c.type).join(', ');
     ...
     */
    generateCategorySection(category, nodes) {
     ...
     */
    generateRequirementsMatrix(nodes) {
...
exports.EnhancedNodeReference = EnhancedNodeReference;
// Export singleton
exports.enhancedNodeReference = new EnhancedNodeReference();
