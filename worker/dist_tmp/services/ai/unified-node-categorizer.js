...
exports.unifiedNodeCategorizer = exports.UnifiedNodeCategorizer = void 0;
...
class UnifiedNodeCategorizer {
     ...
     * @returns Categorization result
     */
    categorizeWithOperation(nodeType, operation) {
        if (!nodeType) {
            return {
                category: 'transformation',
                confidence: 0,
...
exports.UnifiedNodeCategorizer = UnifiedNodeCategorizer;
// Export singleton instance
exports.unifiedNodeCategorizer = new UnifiedNodeCategorizer();
