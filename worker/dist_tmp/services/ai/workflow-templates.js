...
exports.workflowTemplateSelector = exports.WorkflowTemplateSelector = exports.WORKFLOW_TEMPLATES = void 0;
/**
 * Template Registry
...
class WorkflowTemplateSelector {
     ...
     */
    selectTemplate(intent, originalPrompt) {
        ...
        for (const template of exports.WORKFLOW_TEMPLATES) {
            let score = 0;
            const reasons = [];
            ...
            const capabilityMatch = template.requiredCapabilities.filter(cap => intentCapabilities.includes(cap)).length;
     ...
     */
    matchPipelineStructure(template, intent) {
        let match = 0;
    ...
    getTemplateById(templateId) {
        return exports.WORKFLOW_TEMPLATES.find(t => t.id === templateId) || null;
    }
    /**
     * Get all templates
     */
    getAllTemplates() {
        return [...exports.WORKFLOW_TEMPLATES];
    }
}
exports.WorkflowTemplateSelector = WorkflowTemplateSelector;
// Export singleton instance
exports.workflowTemplateSelector = new WorkflowTemplateSelector();
