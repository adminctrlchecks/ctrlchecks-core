...
exports.questionFormatter = exports.QuestionFormatter = void 0;
/**
...
class QuestionFormatter {
     ...
     */
    formatNodeChoiceQuestion(category, options, userPrompt) {
     ...
     */
    getBaseQuestion(category, userPrompt) {
        const templates = {
     ...
     */
    getRecommendation(category, options) {
     ...
     */
    getUserFriendlyLabel(name) {
        return name;
    }
    /**
     * Get pros for specific node
     */
    getProsForNode(nodeId) {
        const prosMap = {
            ...
            db: ["Real-time", "Built-in auth", "Easy setup", "Modern API"],
    ...
    getConsForNode(nodeId) {
        const consMap = {
            ...
            db: ["Vendor lock-in", "Limited customization", "Pricing at scale"],
    ...
    getBestUseCases(nodeId) {
        const useCasesMap = {
            ...
            db: ["Real-time apps", "User management", "Modern web apps", "Quick prototyping"],
...
exports.QuestionFormatter = QuestionFormatter;
// Export singleton instance
exports.questionFormatter = new QuestionFormatter();
