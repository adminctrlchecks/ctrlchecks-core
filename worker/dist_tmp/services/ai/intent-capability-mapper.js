...
exports.intentCapabilityMapper = exports.IntentCapabilityMapper = exports.CapabilityType = void 0;
exports.mapIntentToCapabilities = mapIntentToCapabilities;
...
(function (CapabilityType) {
    CapabilityType["DATA_SOURCE"] = "data_source";
    CapabilityType["TRANSFORMATION"] = "transformation";
    CapabilityType["OUTPUT"] = "output";
    CapabilityType["TRIGGER"] = "trigger";
    CapabilityType["CONDITION"] = "condition";
...
class IntentCapabilityMapper {
     ...
     */
    mapIntentToCapabilities(intent) {
     ...
     */
    mapActionToCapabilities(action) {
        const mappings = [];
     ...
     */
    mapToDataSourceNode(actionType, operation) {
        // Google Services
     ...
     */
    mapToTransformationNodes(actionType, operation) {
        const nodes = [];
        ...
        if (actionType.includes('summarize') || actionType.includes('summary') || actionType === 'summarize') {
            ...
            const capabilityResolution = capability_resolver_1.capabilityResolver.resolveCapability('summarization');
        ...
        if (actionType.includes('classify') || actionType === 'classify') {
            const capabilityResolution = capability_resolver_1.capabilityResolver.resolveCapability('classification');
            if (capabilityResolution) {
                nodes.push(capabilityResolution.nodeType);
            }
            return nodes;
        ...
        if (actionType.includes('ai') || actionType.includes('llm') || actionType.includes('process') || actionType === 'ai_processing') {
            const capabilityResolution = capability_resolver_1.capabilityResolver.resolveCapability('ai_processing');
            if (capabilityResolution) {
                nodes.push(capabilityResolution.nodeType);
            }
            return nodes;
     ...
     * Map to output node
     */
    mapToOutputNode(actionType, operation) {
        // Email
     ...
     */
    mapConditionToNodeType(conditionType) {
...
exports.IntentCapabilityMapper = IntentCapabilityMapper;
// Export singleton instance
exports.intentCapabilityMapper = new IntentCapabilityMapper();
// Export convenience function
function mapIntentToCapabilities(intent) {
    return exports.intentCapabilityMapper.mapIntentToCapabilities(intent);
}
