...
exports.nodeDefaults = exports.NodeDefaultsSystem = void 0;
 ...
 */
class NodeDefaultsSystem {
    /**
     * Get default value for a specific field in a node type
     */
    getDefaultValue(nodeType, fieldName, context) {
     ...
     */
    getRequiredFieldDefaults(nodeType, context) {
        const schema = node_library_1.nodeLibrary.getSchema(nodeType);
        if (!schema) {
            return {};
        }
     ...
     */
    getNodeSpecificDefault(nodeType, fieldName, context) {
...
exports.NodeDefaultsSystem = NodeDefaultsSystem;
exports.nodeDefaults = new NodeDefaultsSystem();
