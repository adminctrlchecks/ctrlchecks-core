...
exports.semanticIntentAnalyzer = exports.SemanticIntentAnalyzer = void 0;
...
Output Format (JSON only, no markdown):
{
  ...
  "context": {
    ...
    fallbackAnalysis(prompt) {
        ...
        const actions = keywords.filter(k => ['post', 'publish', 'send', 'create', 'write', 'share'].includes(k));
        // Extract targets from keywords
        const targets = keywords.filter(k => ['linkedin', 'twitter', 'instagram', 'facebook', 'gmail', 'email'].includes(k));
        return {
            actions,
            targets,
            categories: [category],
...
exports.SemanticIntentAnalyzer = SemanticIntentAnalyzer;
// Export singleton instance
exports.semanticIntentAnalyzer = new SemanticIntentAnalyzer();
