...
exports.systemPromptBuilder = exports.SystemPromptBuilder = exports.CAPABILITY_SELECTION_OUTPUT_SCHEMA = exports.NODE_SELECTION_OUTPUT_SCHEMA = void 0;
...
exports.NODE_SELECTION_OUTPUT_SCHEMA = {
    type: 'object',
...
exports.CAPABILITY_SELECTION_OUTPUT_SCHEMA = {
    type: 'object',
    required: ['steps'],
    properties: {
        steps: {
...
class SystemPromptBuilder {
    ...
    buildIntentPrompt(nodeCatalog, userIntent) {
        const systemPrompt = [
            '## ROLE AND OBJECTIVE',
    ...
    buildCapabilitySelectionPrompt(nodeCatalog, userIntent) {
        const systemPrompt = [
            '## ROLE AND OBJECTIVE',
            ...
            '## OUTPUT FORMAT',
            'You MUST return ONLY valid JSON conforming exactly to this schema:',
            JSON.stringify(exports.CAPABILITY_SELECTION_OUTPUT_SCHEMA, null, 2),
            '',
            '## HARD CONSTRAINTS',
        ...
        return { systemPrompt, outputSchema: exports.CAPABILITY_SELECTION_OUTPUT_SCHEMA };
    }
    buildNodeSelectionPrompt(nodeCatalog, userIntent, ctx) {
        ...
        const systemPrompt = [
            ...
            '## OUTPUT FORMAT',
            'You MUST return ONLY valid JSON conforming exactly to this schema:',
            JSON.stringify(exports.NODE_SELECTION_OUTPUT_SCHEMA, null, 2),
            '',
        ...
        return { systemPrompt, outputSchema: exports.NODE_SELECTION_OUTPUT_SCHEMA };
    }
    // ── Section 3: Edge Reasoning Stage ───────────────────────────────────────
    buildEdgeReasoningPrompt(nodeCatalog, userIntent, ctx) {
    ...
    buildValidationPrompt(nodeCatalog, userIntent, ctx) {
    ...
    buildRepairPrompt(nodeCatalog, userIntent, ctx) {
...
exports.systemPromptBuilder = new SystemPromptBuilder();
