...
exports.promptNormalizer = exports.PromptNormalizer = void 0;
...
class PromptNormalizer {
     ...
     */
    async normalizePrompt(userPrompt) {
     ...
     */
    checkVagueness(prompt) {
        const issues = [];
        let score = 1.0;
        const promptLower = prompt.toLowerCase();
        // Check for vague connectors
        const vagueConnectors = ['and', 'connect', 'link', 'with', 'to'];
        const hasVagueConnector = vagueConnectors.some(connector => promptLower.includes(` ${connector} `) &&
     ...
     */
    buildNormalizationPrompt(userPrompt, vaguenessCheck, isRetry = false) {
...
- RESPOND WITH JSON ONLY - NO EXPLANATIONS, NO PROSE, NO MARKDOWN`;
     ...
     */
    parseNormalizationResponse(response, originalPrompt, attempt = 1) {
        try {
     ...
     */
    fallbackNormalization(userPrompt) {
...
exports.promptNormalizer = new PromptNormalizer();
