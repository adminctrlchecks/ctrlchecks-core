...
exports.nodeCapabilityRegistryDSL = exports.NodeCapabilityRegistryDSL = void 0;
 ...
 */
class NodeCapabilityRegistryDSL {
    constructor() {
     ...
     */
    inferCapabilitiesFromSchema(schema) {
        const capabilities = [];
     ...
     */
    setCapabilities(nodeType, capabilities) {
    ...
    getCapabilities(nodeType) {
        ...
        if (isDebugNode) {
            ...
            console.log(`[NodeCapabilityRegistryDSL] 🔍 DEBUG getCapabilities(${nodeType}): ` +
     ...
     */
    hasCapability(nodeType, capability) {
    ...
    isTransformation(nodeType) {
        ...
        if (isDebugNode) {
            console.log(`[NodeCapabilityRegistryDSL] 🔍 DEBUG isTransformation(${nodeType}): ` +
                `capabilities=[${capabilities.join(', ')}], ` +
     ...
     */
    canServeAsOutput(nodeType) {
        return this.isTerminal(nodeType) ||
            this.isOutput(nodeType) ||
            this.canWriteData(nodeType);
    }
}
exports.NodeCapabilityRegistryDSL = NodeCapabilityRegistryDSL;
// Export singleton instance
exports.nodeCapabilityRegistryDSL = new NodeCapabilityRegistryDSL();
