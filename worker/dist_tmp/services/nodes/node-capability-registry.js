...
exports.nodeCapabilityRegistry = exports.NodeCapabilityRegistry = void 0;
exports.getNodeCapability = getNodeCapability;
exports.areNodesCompatible = areNodesCompatible;
exports.requiresLoop = requiresLoop;
...
class NodeCapabilityRegistry {
    ...
    initialize(nodeLibraryInstance) {
        ...
        let libraryInstance = nodeLibraryInstance || this.nodeLibraryInstance;
        if (!libraryInstance) {
            try {
     ...
     */
    getCapabilityFromSchema(nodeType, schema) {
     ...
     */
    inferCapability(nodeType, schema) {
     ...
     */
    isDataSource(nodeType, category) {
     ...
     */
    isTransformer(nodeType, category) {
     ...
     */
    isOutputAction(nodeType, category) {
     ...
     */
    areCompatible(sourceNodeType, targetNodeType) {
     ...
     */
    requiresLoop(sourceNodeType, targetNodeType) {
        const sourceCapability = this.getCapability(sourceNodeType);
        const targetCapability = this.getCapability(targetNodeType);
        if (!sourceCapability || !targetCapability) {
...
exports.NodeCapabilityRegistry = NodeCapabilityRegistry;
// Export singleton instance
exports.nodeCapabilityRegistry = new NodeCapabilityRegistry();
// Export convenience functions
function getNodeCapability(nodeType) {
    return exports.nodeCapabilityRegistry.getCapability(nodeType);
}
function areNodesCompatible(sourceNodeType, targetNodeType) {
    return exports.nodeCapabilityRegistry.areCompatible(sourceNodeType, targetNodeType);
}
function requiresLoop(sourceNodeType, targetNodeType) {
    return exports.nodeCapabilityRegistry.requiresLoop(sourceNodeType, targetNodeType);
}
