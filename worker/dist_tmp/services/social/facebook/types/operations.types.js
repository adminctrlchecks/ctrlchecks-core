...
exports.facebookOperationsByResource = void 0;
exports.isOperationAllowed = isOperationAllowed;
exports.facebookOperationsByResource = {
...
function isOperationAllowed(resource, operation) {
    return exports.facebookOperationsByResource[resource]?.includes(operation) ?? false;
}
