...
exports.runSQLServerNode = runSQLServerNode;
 ...
 */
async function executeOperation(pool, operation) {
    ...
    switch (operation.name) {
        ...
        case 'storedProcedure': {
            ...
            procRequest.input('procedure', mssql_1.default.VarChar, operation.procedureName);
            if (operation.params) {
                for (const [key, value] of Object.entries(operation.params)) {
 ...
 * Run SQL Server node
 */
async function runSQLServerNode(context) {
