...
exports.requiresExplicitFiltering = requiresExplicitFiltering;
exports.requestsFullDataset = requestsFullDataset;
/**
 ...
 */
function requiresExplicitFiltering(intent) {
    // Check for explicit filtering qualifiers
    const filteringQualifiers = ['only', 'just', 'specific', 'particular', 'selected'];
    const hasFilteringQualifier = intent.qualifiers.some(q => filteringQualifiers.includes(q));
    // Check for filtering actions
    const filteringActions = ['filter', 'select', 'extract', 'find'];
    const hasFilteringAction = intent.actions.some(a => filteringActions.includes(a));
 ...
 */
function requestsFullDataset(intent) {
