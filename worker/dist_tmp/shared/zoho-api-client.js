...
exports.ZohoApiClient = void 0;
exports.createZohoApiClient = createZohoApiClient;
...
class ZohoApiClient {
    constructor(credentials) {
        ...
        this.baseUrl = (0, zoho_oauth_1.getZohoApiBaseUrl)(this.region);
    ...
    async refreshAccessToken() {
        try {
            const tokenEndpoint = (0, zoho_oauth_1.getZohoTokenEndpoint)(this.region);
            const response = await axios_1.default.post(tokenEndpoint, null, {
                params: {
     ...
     */
    async makeRequest(method, url, data, params, headers) {
        try {
     ...
     */
    async fetchPaginated(url, params = {}, accumulator = []) {
        const page = params.page || 1;
        const perPage = params.per_page || 200;
        const limit = params.limit || 1000; // Default max records
        const response = await this.makeRequest('GET', url, undefined, { page, per_page: perPage });
        if (!response.success) {
            return response;
        }
        ...
        if (hasMore && allRecords.length < limit) {
            return this.fetchPaginated(url, { ...params, page: nextPage }, allRecords);
        }
        return {
            success: true,
    ...
    // ============================================
    async executeCrm(resource, operation, params) {
        switch (resource) {
            case 'record':
     ...
     */
    async crmRecord(operation, params) {
        ...
        switch (operation) {
            case 'list': {
                ...
                if (rest.sort_by)
                    listParams.sort_by = rest.sort_by;
                if (rest.sort_order)
                    listParams.sort_order = rest.sort_order;
                if (rest.fields)
                    listParams.fields = rest.fields;
                if (rest.criteria)
                    listParams.criteria = rest.criteria;
     ...
     */
    async crmBulkRead(operation, params) {
        ...
        switch (operation) {
            case 'create_job': {
                ...
                if (rest.criteria)
                    jobData.criteria = rest.criteria;
     ...
     */
    async crmRelatedList(operation, params) {
     ...
     */
    async crmAttachment(operation, params) {
     ...
     * CRM Note operations
     */
    async crmNote(operation, params) {
     ...
     */
    async crmBlueprint(operation, params) {
     ...
     * CRM User operations
     */
    async crmUser(operation, params) {
     ...
     */
    async crmOrganization(operation, params) {
        switch (operation) {
            case 'get': {
     ...
     */
    async crmModuleMetadata(operation, params) {
     ...
     */
    async crmCoql(operation, params) {
        ...
        if (rest.page)
            coqlParams.page = rest.page;
        if (rest.per_page)
            coqlParams.per_page = rest.per_page;
        return this.makeRequest('GET', '/crm/v3/coql', undefined, coqlParams);
    }
    // ============================================
    // ZOHO BOOKS SERVICE HANDLERS
    // ============================================
    async executeBooks(resource, operation, params) {
     ...
     */
    async booksOrganization(operation, params) {
     ...
     */
    async booksContact(operation, params) {
        ...
        switch (operation) {
            case 'list': {
                ...
                if (rest.filter_by)
                    listParams.filter_by = rest.filter_by;
                if (rest.sort_column)
                    listParams.sort_column = rest.sort_column;
                return this.makeRequest('GET', basePath, undefined, listParams);
            }
            case 'get': {
                if (!id) {
     ...
     */
    async booksInvoice(operation, params) {
     ...
     */
    async booksEstimate(operation, params) {
     ...
     */
    async booksItem(operation, params) {
     ...
     */
    async booksBill(operation, params) {
     ...
     */
    async booksExpense(operation, params) {
     ...
     */
    async booksPayment(operation, params) {
        ...
        switch (operation) {
            case 'list': {
                ...
                if (rest.invoice_id)
                    listParams.invoice_id = rest.invoice_id;
                return this.makeRequest('GET', basePath, undefined, listParams);
            }
            case 'get': {
                if (!paymentId) {
     ...
     */
    async booksCreditNote(operation, params) {
     ...
     */
    async booksVendor(operation, params) {
     ...
     */
    async booksTax(operation, params) {
     ...
     */
    async booksBankAccount(operation, params) {
     ...
     */
    async booksJournal(operation, params) {
     ...
     */
    async booksPurchaseOrder(operation, params) {
     ...
     */
    async booksSalesOrder(operation, params) {
     ...
     */
    async booksRecurringInvoice(operation, params) {
     ...
     */
    async booksProject(operation, params) {
     ...
     */
    async booksTimesheet(operation, params) {
    ...
    // ============================================
    async executeCreator(resource, operation, params) {
        switch (resource) {
            case 'application':
     ...
     */
    async creatorApplication(operation, params) {
     ...
     */
    async creatorForm(operation, params) {
     ...
     */
    async creatorRecord(operation, params) {
     ...
     */
    async creatorReport(operation, params) {
    ...
    // ============================================
    async executeSheets(resource, operation, params) {
        switch (resource) {
            case 'workbook':
     ...
     */
    async sheetsWorkbook(operation, params) {
     ...
     */
    async sheetsWorksheet(operation, params) {
     ...
     */
    async sheetsRecord(operation, params) {
        ...
        switch (operation) {
            case 'list': {
                ...
                if (rest.has_header_row !== undefined)
                    listParams.has_header_row = rest.has_header_row;
                return this.makeRequest('GET', basePath, undefined, listParams);
            }
            case 'add': {
                if (!data) {
    ...
    // ============================================
    async executeTasks(resource, operation, params) {
        switch (resource) {
            case 'personal_task':
     ...
     */
    async tasksPersonalTask(operation, params) {
        ...
        switch (operation) {
            case 'list': {
                ...
                if (rest.status)
                    listParams.status = rest.status;
                if (rest.priority)
                    listParams.priority = rest.priority;
                return this.makeRequest('GET', basePath, undefined, listParams);
            }
            case 'get': {
                if (!taskId) {
     ...
     */
    async tasksGroupTask(operation, params) {
     ...
     */
    async tasksProject(operation, params) {
     ...
     */
    async tasksSubtask(operation, params) {
    ...
    // ============================================
    async executeBilling(resource, operation, params) {
        switch (resource) {
            case 'customer':
     ...
     */
    async billingCustomer(operation, params) {
     ...
     */
    async billingProduct(operation, params) {
     ...
     */
    async billingPlan(operation, params) {
     ...
     */
    async billingSubscription(operation, params) {
        ...
        switch (operation) {
            case 'list': {
                ...
                if (rest.customer_id)
                    listParams.customer_id = rest.customer_id;
                return this.makeRequest('GET', basePath, undefined, listParams);
            }
            case 'get': {
                if (!subscriptionId) {
     ...
     */
    async billingInvoice(operation, params) {
        ...
        switch (operation) {
            case 'list': {
                ...
                if (subscriptionId)
                    listParams.subscription_id = subscriptionId;
                return this.makeRequest('GET', basePath, undefined, listParams);
            }
            case 'get': {
                if (!invoiceId) {
     ...
     */
    async billingPayment(operation, params) {
        ...
        switch (operation) {
            case 'list': {
                ...
                if (invoiceId)
                    listParams.invoice_id = invoiceId;
                return this.makeRequest('GET', basePath, undefined, listParams);
            }
            case 'get': {
                if (!paymentId) {
     ...
     */
    async billingAddon(operation, params) {
     ...
     */
    async billingEvent(operation, params) {
        ...
        switch (operation) {
            case 'list': {
                ...
                if (rest.event_type)
                    listParams.event_type = rest.event_type;
                return this.makeRequest('GET', basePath, undefined, listParams);
            }
            default:
                return {
    ...
    // ============================================
    async executeEmail(resource, operation, params) {
        switch (resource) {
            case 'email':
     ...
     */
    async emailSend(operation, params) {
     ...
     */
    async emailAccount(operation, params) {
     ...
     */
    async emailSchedule(operation, params) {
    ...
    // ============================================
    async executeTables(resource, operation, params) {
        switch (resource) {
            case 'record':
     ...
     */
    async tablesRecord(operation, params) {
...
exports.ZohoApiClient = ZohoApiClient;
// Export a factory function for easy instantiation
function createZohoApiClient(credentials) {
