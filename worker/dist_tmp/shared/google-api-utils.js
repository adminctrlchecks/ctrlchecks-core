...
exports.parseGoogleApiError = parseGoogleApiError;
...
exports.logApiOperation = logApiOperation;
...
function parseGoogleApiError(response, errorText) {
...
function sanitizeString(input, fieldName, maxLength) {
...
function extractDocumentId(urlOrId) {
    if (!urlOrId || typeof urlOrId !== 'string') {
...
function logApiOperation(service, operation, details) {
    const logData = {
        service,
        operation,
