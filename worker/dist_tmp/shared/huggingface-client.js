...
exports.HuggingFaceClient = exports.HuggingFaceRouterClient = void 0;
class HuggingFaceRouterClient {
    constructor(apiKey, baseUrl = "https://router.huggingface.co", defaultTimeout = 60000, maxRetries = 3) {
        if (!apiKey) {
    ...
    async generateText(modelName, prompt, options = {}) {
        const modality = this.detectModality(modelName);
        let messages;
    ...
    static fromEnvironment(baseUrl) {
...
exports.HuggingFaceRouterClient = HuggingFaceRouterClient;
// Backward compatibility alias
exports.HuggingFaceClient = HuggingFaceRouterClient;
